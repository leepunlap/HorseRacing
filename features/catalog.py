...
FEATURES: list[Feature] = [
    ...
    Feature("H005", 1, "出生月份", "Birth month", "Cohort proxy; northern 1-2 favoured", "B1,B23", "_nan_stub"),
    Feature("H006", 1, "南北半球", "Hemisphere", "Birth hemisphere N/S", "B27,B33", "_nan_stub"),
    ...
    Feature("H011", 1, "父系", "Sire", "Sire identity hash", "B5,B26", "_nan_stub"),
    Feature("H012", 1, "母父", "Dam sire", "Dam-sire identity hash", "B5,B26", "_nan_stub"),
    ...
    Feature("H031", 3, "父系距離適性", "Sire×distance", "Sire ROI at this distance", "B2,B26", "_nan_stub"),
    Feature("H032", 3, "父系場地適性", "Sire×surface", "Sire turf-vs-dirt edge", "B2,B5", "_nan_stub"),
    Feature("H033", 3, "馬齡×距離", "Age×distance", "Age-bucket WR at distance", "B14,B23", "h033_age_dist"),
    Feature("H034", 3, "左右轉", "Track turn direction", "L vs R track preference", "B14,B36", "_nan_stub"),
    ...
    Feature("H037", 3, "出閘速度", "Jump speed", "First-200m position vs field", "B11,B12", "_nan_stub"),
    ...
    Feature("H049", 4, "練馬師裝備改動", "Trainer gear-change ROI", "Trainer angle on gear changes", "B2,B11", "_nan_stub"),
    ...
    Feature("H056", 5, "起閘速度", "Gate break speed", "First-200m sectional vs field", "B11,B12", "_nan_stub"),
    ...
    Feature("H066", 6, "騎師體重", "Jockey weight", "Jockey body weight", "B7,B33", "_nan_stub"),
    Feature("H067", 6, "鞍具重量", "Saddle weight", "Equipment weight", "B33", "_nan_stub"),
    ...
    Feature("H092", 8, "上場分段殘差", "Last sectional residual", "vs par", "B10,B11", "_nan_stub"),
    Feature("H093", 8, "終段速度%", "Finishing Speed %", "Rowlands FSP", "B10", "_nan_stub"),
    ...
    Feature("H100", 9, "首次馬銜", "First-time bit/tongue tie", "Bit change marker", "B11,B14", "_nan_stub"),
    Feature("H101", 9, "蹄鐵變動", "Shoeing change", "Bar shoe / glue-on", "B11", "_nan_stub"),
    Feature("H102", 9, "馬鞍變動", "Saddle change", "Synthetic vs leather", "B33", "_nan_stub"),
    Feature("H103", 9, "多重裝備變動", "Multiple gear changes", "N items changed", "B11,B14", "h103_multi_gear"),
    Feature("H104", 9, "用藥變動", "Medication change", "HK: limited; US Lasix", "B11,B24", "_nan_stub"),
    ...
    Feature("H107", 9, "獸醫復出", "Off-vet returner", "First start post-vet", "B38,B39", "_nan_stub"),
    ...
    Feature("H113", 10, "E1 早段", "E1 early speed", "Brisnet-style figure", "B11,B16", "_nan_stub"),
    Feature("H114", 10, "E2 早段", "E2 early speed", "Brisnet-style figure", "B11,B16", "_nan_stub"),
    ...
    Feature("H118", 10, "配速生存者", "Pace survivor", "Closer that withstands hot pace", "B12,B16", "_nan_stub"),
    ...
    Feature("H139", 12, "父系×場地", "Sire×surface", "Pedigree-derived", "B5,B26", "_nan_stub"),
    Feature("H140", 12, "父系×距離", "Sire×distance", "Pedigree-derived", "B26", "_nan_stub"),
    ...
    Feature("H143", 12, "用藥×場地", "Med×surface", "HK: NaN", "B11,B24", "_nan_stub"),
    ...
    Feature("H147", 13, "Harville P(1-2)", "Harville top-2 prob", "From P(win)", "B8,B9", "_nan_stub"),
    Feature("H148", 13, "Harville P(1-2-3)", "Harville top-3 prob", "From P(win)", "B8,B9", "_nan_stub"),
    Feature("H149", 13, "Henery 修正", "Henery refinement", "Exponential time model", "B8,B9", "_nan_stub"),
    Feature("H150", 13, "Plackett-Luce", "Plackett-Luce likelihood", "Listwise rank", "B9,B31", "_nan_stub"),
    Feature("H151", 13, "Discounted Harville", "Discounted Harville", "Longshot discount", "B8", "_nan_stub"),
    ...
    Feature("H154", 13, "三甲組合", "Trifecta prob vector", "Top-3 ordered probs", "B8,B16", "_nan_stub"),
    ...
    Feature("H166", 14, "多平台一致性", "Multi-platform consistency", "Stub", "B32,B35", "_nan_stub"),

    # ─── Category 15: Track dynamics (H167-H174) ──────────────────────────
    Feature("H167", 15, "當日場地偏差", "Same-day bias", "Winners' style today", "B41,B43", "h167_today_bias"),
    Feature("H168", 15, "par 時間殘差", "Par-time residual", "Race vs par sectional", "B10,B41", "_nan_stub"),
