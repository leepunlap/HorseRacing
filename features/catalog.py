...
FEATURES: list[Feature] = [
    ...
    Feature("H037", 3, "出閘速度", "Jump speed", "First-200m position vs field", "B11,B12", "_nan_stub", enabled_default=False),
    ...
    Feature("H056", 5, "起閘速度", "Gate break speed", "First-200m sectional vs field", "B11,B12", "_nan_stub", enabled_default=False),
    ...
    Feature("H092", 8, "上場分段殘差", "Last sectional residual", "vs par", "B10,B11", "_nan_stub", enabled_default=False),
    Feature("H093", 8, "終段速度%", "Finishing Speed %", "Rowlands FSP", "B10", "_nan_stub", enabled_default=False),
    ...
    Feature("H113", 10, "E1 早段", "E1 early speed", "Brisnet-style figure", "B11,B16", "_nan_stub", enabled_default=False),
    Feature("H114", 10, "E2 早段", "E2 early speed", "Brisnet-style figure", "B11,B16", "_nan_stub", enabled_default=False),
    ...
    Feature("H118", 10, "配速生存者", "Pace survivor", "Closer that withstands hot pace", "B12,B16", "_nan_stub", enabled_default=False),
